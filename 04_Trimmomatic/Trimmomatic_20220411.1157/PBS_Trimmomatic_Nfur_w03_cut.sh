...
#PBS -o /storage/pruhonice1-ibot/home/volen_a/jani/04_Trimmomatic/Trimmomatic_20220411.1157/Nfur_w03_cut_Trimmomatic.stdout
#PBS -e /storage/pruhonice1-ibot/home/volen_a/jani/04_Trimmomatic/Trimmomatic_20220411.1157/Nfur_w03_cut_Trimmomatic.stderr
...
mv Nfur_f03_cut_1.fastq.gz Nfur_w03_cut_1.fastq.gz
mv Nfur_f03_cut_2.fastq.gz Nfur_w03_cut_2.fastq.gz

module add trimmomatic-0.39

java -jar /software/trimmomatic/0.39/trimmomatic-0.39/Trimmomatic-0.39/trimmomatic-0.39.jar PE -threads 15 -phred33 -trimlog Nfur_w03_cut_trimlog.txt -basein Nfur_w03_cut_1.fastq.gz -baseout Nfur_w03_cut_trimmed.fastq.gz ILLUMINACLIP:./Truseq_PE_frankenstein.fa:2:30:10:1:true SLIDINGWINDOW:5:20 HEADCROP:10 MINLEN:90

rm ${SCRATCHDIR}/Nfur_w03_cut_1.fastq.gz
rm ${SCRATCHDIR}/Nfur_w03_cut_2.fastq.gz
